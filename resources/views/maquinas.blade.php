  ...
  <div class="bg-white rounded-2xl shadow-md p-4 hover:shadow-xl transition duration-300">
    <div class="flex flex-row justify-between items-center h-full">
        ...
        <div class="w-1/2 pr-2 flex flex-col gap-2">
            ...
            <a href="#"
                class="inline-flex items-center px-3 py-1 text-sm font-medium text-white bg-blue-700 rounded-md hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Read more
        ...
        <div class="w-1/2 pl-2">
            <img 
                class="w-full h-36 object-cover rounded-md border border-gray-200 shadow-sm dark:border-gray-700"
